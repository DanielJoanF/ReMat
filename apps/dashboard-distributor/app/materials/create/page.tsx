...
export default function CreateMaterialPage() {
  ...
  const onSubmit = async (data: MaterialFormData) => {
    try {
      ...
      toast({
        type: 'error',
        message: err instanceof Error ? err.message : 'Gagal menyimpan material',
      });
    } finally {
      setSubmitting(false);
    }
    ...
    <DashboardLayout>
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                <textarea
                  placeholder="Deskripsikan material secara detail..."
                  rows={4}
                  className={`block w-full rounded-md border px-3 py-2 text-sm shadow-sm placeholder:text-gray-400 focus:border-[#1B5E20] focus:ring-1 focus:ring-[#1B5E20] ${
          ...
          <Card>
            <CardHeader>
              <CardTitle>Foto Material</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="mb-4 text-sm text-gray-500">
                Upload foto produk (opsional). Foto diunggah setelah material tersimpan.
              </p>
